...
const SCENARIO_TREE = {
  ...
  nodes: {
    ...
    q1: {
      id: "q1",
      title: "Jai hind",
     videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-0.mp4",
      
      prompt: "Kya aap ye number use karte hai?",
    ...
    q2: {
      id: "q2",
      title: "Complaint and record statement",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-7.mp4",
      prompt: "Kya aap apna complaint record karvayengein?",
      yes: "q4",      // If YES → go to q4
      no: "q5",       // If NO → go to q5
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      outcome: null
    },
    ...
    q4: {
      id: "q4",
      title: "OTP before statement",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-8.mp4",
      prompt: "Kya aap OTP share karengein?",
      yes: "q15",      // If YES → go to q8
      no: "q8",      // If NO → go to q14
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      outcome: null
    },
    ...
    q3: {
      id: "q3",
      title: "Statement/ Aadhaar share",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-1.mp4",
      prompt: "Kya aap apna Aadhaar aur pura naam batayengein?",
    ...
    q5: {
      id: "q5",
      title: "For your ease",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-3.mp4",
      prompt: "Kya ab aap apna statement record karvayengein?",
    ...
    q6: {
      id: "q6",
      title: "Verification is imp",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-4.mp4",
      prompt: "Kya aap apna statement record karvayengein?",
      yes: "q7",   // If YES → go to q8
      no: "q14",    // If NO → go to q9
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      outcome: null
    },
    ...
    q8: {
      ...
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-3.mp4",
      prompt: "Kya aap apna statement record karvayengein?",
      yes: "q15",    // If YES → go to q10
      no: "q14",     // If NO → go to q11
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      outcome: null
    },
    ...
    q9: {
      id: "q9",
      title: "Pradeep/ OTP verification",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-2.mp4",
      prompt: "Kya aap OTP share karengein?",
      yes: "q15",     // If YES → go to q8
      no: "q11",     // If NO → go to q13
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      outcome: null
    },
    q10: {
      ...
      title: "For your ease",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-3.mp4",
      prompt: "Kya ab aap apna Aadhaar aur pura naam batayengein?",
      yes: "q9",    // If YES → go to q12
      no: "q14",     // If NO → go to q13
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      outcome: null
    },
    q11: {
      id: "q11",
      title: "Verifiaction is imp",
      videoUrl: "https://s3.ap-south-1.amazonaws.com/cdn.joinsiren.com/mock-videos/video-4.mp4",
      prompt: "Kya ab aap apna OTP share karengein?",
      yes: "q15",    // If YES → go to q10
      no: "q14",     // If NO → go to q13
      yesLabel: "Haan",  // Custom label for yes button (optional)
      noLabel: "Nahi",    // Custom label for no button (optional)
      ...
      <div style={styles.phoneFrame}>
        ...
        {!started && (
          <div style={styles.startScreen}>
            <img 
              src="https://res.cloudinary.com/dndqxjnvx/image/upload/v1763116526/MOCK_cover_oaup46.jpg" 
              alt="Digital Arrest Mock Scam" 
              style={styles.startImage}
            />
            <h1 style={styles.startTitle}>Digital Arrest Mock Scam</h1>
